...
export function Home() {
	return (
		<>
			<section className='relative bg-gradient-to-r from-[#8f06241a]  to-[#f58b4927]  w-full pb-16'>
				<div className='relative z-30 mySection mx-auto mt-14 flex flex-col text-left'>
					<h2 className='font-bold text-2xl sm:text-[2.5rem] -mb-1 sm:-mb-0 text-[#36393c]'>Freelance</h2>
					...
					<div className='flex flex-col lg:flex-row'>
						<button className='w-fit bg-gradient-to-r from-[#8F062F] to-[#cc4e3f] text-sm sm:text-base h-fit min-w-fit py-[5px] px-4 rounded-3xl mt-10 lg:mt-16 font-semibold text-white'>
							Me contacter{" "}
